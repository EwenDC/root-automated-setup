...
export default {
  ...
  faction: {
    alliance: {
      ...
      setup:
        "<ol><li>Draw 3 <b>cards</b> and add them face down to your Supporters stack.</li><li>Fill your Sympathy track with <b>sympathy tokens</b>.</li><li>Put your 3 <b>bases</b> on your matching Bases spaces.</li></ol>",
    },
    corvid: {
      ...
      setup:
        "<ol><li>Choose a homeland clearing. Put 1 <b>warrior</b> and 1 <b>plot token</b> of your choice face down there.</li><li>Put 1 <b>warrior</b> in a clearing of each suit. <i>(Counting the previous step, place 4 warriors in total.)</i></li></ol>",
    },
    cult: {
      name: "Lizard Cult",
    ...
    duchy: {
      ...
      setup:
        "<ol><li>Choose a homeland clearing that is not adjacent to enemy homelands.</li><li>Put 2 <b>warriors</b> and 1 <b>tunnel</b> in your homeland. Put 5 <b>warriors</b> among clearings adjacent to it as evenly as possible.</li><li>Put your <b>Burrow board</b> near the map. Fill your Buildings tracks with your <b>citadels</b> and <b>markets</b>. Put your 9 <b>minister cards</b> on your Unswayed Ministers pile. Put your 9 <b>crowns</b> on the square spaces showing victory points.</li></ol>",
    },
    eyrie: {
      ...
      setup:
        "<ol><li>Choose a homeland clearing on the map edge clearing that has 2+ clearings between it and enemy homelands.</li><li>Put 6 <b>warriors</b> and 1 <b>roost</b> in your homeland.</li><li>Put any <b>leader card</b> on your Leader Card slot. Keep the other 3 leaders face up nearby.</li><li>Tuck your 2 <b>Loyal Viziers</b> under the Decree column slots as listed on your current leader.</li><li>Fill your Roosts spaces with <b>roosts</b>, except the leftmost.</li></ol>",
    },
    keepers: {
      ...
      setup:
        "<ol><li>Shuffle all 12 <b>relic tokens</b> face down. Place one face down randomly in each forest.</li><li>Choose 2 adjacent homeland clearings on the map edge that have 2+ clearings between them and enemy homelands. Put 4 <b>warriors</b> in each homeland.</li><li>Put any remaining <b>relics</b>, as evenly as possible, among any forests that are not adjacent to your homelands.</li><li>Tuck a <b>Faithful Retainer</b> card into each of your Retinue column slots.</li></ol>",
    },
    marquise: {
    ...
    riverfolk: {
      ...
      setup:
        "<ol><li>Put 4 <b>warriors</b> among any clearings along the river.</li><li>Put 3 <b>warriors</b> in your Payments box.</li><li>Fill your Trade Posts tracks with matching <b>trade posts</b>.</li><li>Put your 3 <b>service markers</b> on your Services track, setting a price for each service.</li></ol>",
    },
    vagabond: {
      name: "Vagabond",
      ...
      setup:
        '<ol><li>Put your <b>pawn</b> in any forest.</li><li>Shuffle the quest deck. Draw 3 <b>quests</b> to deal out nearby.</li><li>Put the <Bag/>, <Boot/>, <Hammer/>, and <Sword/> <b>ruin items</b> <i>(marked with "R")</i> under the ruins randomly, unless this has already been done.</li><li>Put the "{{vagabond}}" <b>character card</b> in your Character Card slot. Put the <InitialStartingItems>, </InitialStartingItems>, and <FinalStartingItem/> <b>starting items</b> <i>(marked with "S")</i> in your Satchel and on their matching tracks, as needed.</li></ol>',
      setup_vagabondSetUp:
        '<ol><li>Put your <b>pawn</b> in any forest.</li><li>Shuffle the quest deck. Draw 3 <b>quests</b> to deal out nearby.</li><li>Put the additional <Bag/>, <Boot/>, <Hammer/>, and <Sword/> <b>ruin items</b> <i>(marked with "R")</i> under the ruins randomly <i>(with the existing items)</i>.</li><li>Put the "{{vagabond}}" <b>character card</b> in your Character Card slot. Put the <InitialStartingItems>, </InitialStartingItems>, and <FinalStartingItem/> <b>starting items</b> <i>(marked with "S")</i> in your Satchel and on their matching tracks, as needed.</li></ol>',
    },
    warlord: {
      ...
      setup:
        '<ol><li>Choose a homeland clearing on the map edge that has 2+ clearings between it and enemy homelands.</li><li>Put your <b>warlord</b>, 4 <b>warriors</b>, and 1 <b>stronghold</b> in your homeland.</li><li>Pur your <b>Stubborn mood card</b> in your Mood Card slot.</li><li>Put the <Bag/>, <Boot/>, <Hammer/>, and <Sword/> <b>ruin items</b> <i>(marked with "R")</i> under the ruins randomly, unless this has already been done.</li></ol>',
      setup_vagabondSetUp:
        "<ol><li>Choose a homeland clearing on the map edge that has 2+ clearings between it and enemy homelands.</li><li>Put your <b>warlord</b>, 4 <b>warriors</b>, and 1 <b>stronghold</b> in your homeland.</li><li>Pur your <b>Stubborn mood card</b> in your Mood Card slot.</li></ol>",
    },
  },
  hireling: {
    band: {
