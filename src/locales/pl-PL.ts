...
export default {
  ...
  faction: {
    ...
    corvid: {
      ...
      advancedSetup: `<ol><li>Wybierz polanę ojczystą. Umieść tam 1 <b>wojownika</b> i 1 wybrany prze siebie zakryty <b>żeton intrygi</b>.</li><li>Umieść 1 <b>wojownika</b> w polanie każdego symbolu. <i>(Licząc poprzedni krok, umieść łącznie 4 wojowników.)</i></li></ol>`,
    },
    cult: {
