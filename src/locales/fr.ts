...
export default {
  ...
  faction: {
    alliance: {
      ...
      advancedSetup: `<ol><li>Piochez 3 <b>cartes</b> et ajoutez-les face cachée à vos partisans.</li><li>Remplissez votre piste de Sympathie avec vos <b>jetons de Sympathie</b>.</li><li>Placez vos 3 <b>bases</b> sur les emplacements correspondants.</li></ol>`,
    },
    corvid: {
      ...
      setup: `<ol><li><b>Préparer les guerriers et les Complots.</b> Formez une réserve de 15 guerriers et 8 jetons de Complot face cachée.</li><li><b>Déploiement.</b> Placez 1 guerrier dans une clairière de chaque couleur <i>(3 en tout)</li>.</li></ol>`, // Loi de Root v2023.08.03@13.3
      advancedSetup: `<ol><li>Choisissez une Patrie. Placez-y 1 <b>guerrier</b> et 1<b>jeton Complot</b> de votre choix face cachée.</li><li>Placez 1 <b>guerrier</b> dans une clairière de chaque couleur. <i>(Vous aurez donc placé 4 guerriers en tout à l’issue des étapes 1 et 2.)</i></li></ol>`,
    },
    cult: {
    ...
    warlord: {
      ...
      setup: `<ol><li><b>Garnison.</b> Placez votre seigneur de guerre, 4 guerriers et 1 Bastion dans une clairière en coin qui n’est la clairière de départ en coin d’aucun autre joueur et, si possible, qui est diagonalement opposée à une clairière de départ en coin.</li><li><b>Placer les objets.</b> Placez les 4 objets <Bag/>, <Boot/>, <Hammer/> et <Sword/> marqués d’un « R » aléatoirement sous les ruines, à moins que cette étape n’ait déjà été effectuée.</li><li><b>Devenir Tenace.</li> Placez la carte d’Humeur Tenace dans la case d’Humeur.</li></ol>`, // Loi de Root v2023.08.03@14.3
      setup_vagabondSetUp: `<ol><li><b>Garnison.</b> Placez votre seigneur de guerre, 4 guerriers et 1 Bastion dans une clairière en coin qui n’est la clairière de départ en coin d’aucun autre joueur et, si possible, qui est diagonalement opposée à une clairière de départ en coin.</li><li><b>Devenir Tenace.</li> Placez la carte d’Humeur Tenace dans la case d’Humeur.</li></ol>`, // Loi de Root v2023.08.03@14.3
      advancedSetup: `<ol><li>Choisissez une Patrie sur le bord du plateau avec au moins 2 clairières entre celle-ci et les Patries adverses.</li><li>Placez votre <b>seigneur de guerre</b>, 4 <b>guerriers</b>, et 1 <b>Bastion</b> dans votre Patrie.</li><li>Placez votre <b>carte d’Humeur Tenace</b> dans l’emplacement correspondant.</li><li>Placez les 4 <b>objets « R » <Bag/>, <Boot/>, <Hammer/> et <Sword/> sous les ruines au hasard, si ce n’est pas déjà fait.</li></ol>`,
      advancedSetup_vagabondSetUp: `<ol><li>Choisissez une Patrie sur le bord du plateau avec au moins 2 clairières entre celle-ci et les Patries adverses.</li><li>Placez votre <b>seigneur de guerre</b>, 4 <b>guerriers</b>, et 1 <b>Bastion</b> dans votre Patrie.</li><li>Placez votre <b>carte d’Humeur Tenace</b> dans l’emplacement correspondant.</li></ol>`,
    },
  },
  hireling: {
    band: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 5 guerriers Groupe dans la boite de jeu. Placez 2 guerriers Groupe dans 2 clairières différentes. Placez les guerriers restants et la carte Nomade <i>(face promue « Groupe Populaire » visible)</i> à côté du plateau.`,
      setup_demoted: `Joueur {{count}}, prenez la carte Nomade et les 5 guerriers Groupe dans la boite de jeu. Placez-les à côté du plateau <i>(avec la carte Nomade face rétrogradée « Groupe de rue » visible)</i>.`,
    },
    bandits: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 4 guerriers Bandits dans la boite de jeu. Placez 2 guerriers Bandits, chacun sur un chemin qui n’en contient pas. Placez les guerriers restants et la carte Nomade <i>(face promue « Bandits des Grands Chemins » visible)</i> à côté du plateau.`,
      setup_demoted: `Joueur {{count}}, prenez la carte Nomades et les 4 guerriers Bandits dans la boite de jeu. Placez-les à côté du plateau <i>(avec la carte Nomade face rétrogradée « Gangs de Bandits » visible)</i>.`,
    },
    dynasty: {
      name: `Dernière Dynastie`,
      setupTitle: `Mise en place de la Dernière Dynastie`,
      setupTitle_demoted: `Mise en place des Merles Nobles`,
      setup: `Joueur {{count}}, prenez la carte Nomade et les 5 guerriers Dynastie dans la boite de jeu. Placez les 5 guerriers Dynastie dans une clairière sur un bord du plateau. Placez la carte Nomade <i>(face promue « Dernière Dynastie » visible)</i> à côté du plateau.`,
      setup_demoted: `Joueur {{count}}, prenez la carte Nomade de la Dernière Dynastie dans la boîte de jeu. Placez-la à côté du plateau <i>(face rétrogradée « Merles Nobles » visible)</i>.`,
    },
    exile: {
      name: `L’Exilé`,
      setupTitle: `Mise en place de l’Exilé`,
      setupTitle_demoted: `Mise en place du Brigand`,
      setup: `Joueur {{count}}, prenez la carte Nomade, le pion Exilé et les 3 objets Gourdin dans la boite de jeu. Placez le pion Exilé dans un bois. Placez la carte Nomade <i>(face promue « L’Exilé » visible)</i> à côté du plateau, et placez les 3 objets Gourdin dessus <i>(face visible)</i>.`,
    ...
    expedition: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade, les 8 guerriers Expédition et les 3 jetons Caverne dans la boite de jeu. Placez 1 jeton Caverne et 3 guerriers Expédition dans une clairière au choix. Placez les guerriers et jetons restants et la carte Nomade <i>(face promue « Expédition de Lumière » visible)</i> à côté du plateau.`,
      setup_demoted: `Joueur {{count}}, prenez la carte Nomade de l’Expédition de Lumière dans la boîte de jeu. Placez-la à côté du plateau <i>(face rétrogradée « Taupes Artisanes » visible)</i>.`,
    },
    flamebearers: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 6 guerriers Porteurs dans la boite de jeu. Placez 2 guerriers Porteurs dans une ou plusieurs clairières au choix. Placez les guerriers restants et la carte Nomade <i>(face promue « Porteurs de Flamme » visible)</i> à côté du plateau.`,
    ...
    flotilla: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et le pion Flottille dans la boite de jeu. Placez le pion Flottille dans une clairière sur le bord du plateau et le long de la rivière. Placez la carte Nomade <i>(face promue « Flottille de la Rivière » visible)</i> à côté du plateau.`,
    ...
    patrol: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 12 guerriers Gardes Forestiers dans la boite de jeu. Placez 1 guerrier Gardes Forestiers dans chaque clairière. Placez la carte Nomade <i>(face promue « Gardes Forestiers » visible)</i> à côté du plateau.`,
    ...
    prophets: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 4 guerriers Prophète dans la boite de jeu. Placez 1 guerrier Prophète dans chaque clairière avec une ruine. Placez la carte Nomade <i>(face promue « Prophètes du Soleil » visible)</i> à côté du plateau.`,
    ...
    protector: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et le pion Protecteur dans la boite de jeu. Placez le pion Protecteur dans une clairière au choix. Placez la carte Nomade <i>(face promue « Protecteur Furieux » visible)</i> à côté du plateau.`,
      setup_demoted: `Joueur {{count}}, prenez la carte Nomade et le pion Protecteur dans la boite de jeu. Placez-les à côté du plateau <i>(avec la carte Nomade face rétrogradée « Protecteur Stoïque » visible)</i>.`,
    },
    spies: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade et les 6 guerriers Espions dans la boite de jeu. Placez 2 guerriers Espions, un chacun dans 2 clairières différentes de la même couleur. Placez les guerriers restants et la carte Nomade <i>(face promue « Espions Corvidés » visible)</i> à côté du plateau.`,
    ...
    uprising: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade, les 4 guerriers Révolte et le dé de révolte dans la boite de jeu. Lancez le dé de révolte 2 fois, et placez un guerrier Révolte dans des clairières de la même couleur. Placez les guerriers restants, le dé et la carte Nomade <i>(face promue « Révolte Printanière » visible)</i> à côté du plateau.`,
    ...
    vaultkeepers: {
      ...
      setup: `Joueur {{count}}, prenez la carte Nomade, les 6 guerriers Gardiens et les 6 bâtiments Coffre dans la boite de jeu. Placez 2 guerriers Gardiens et 1 bâtiment Coffre dans une clairière avec un emplacement de construction disponible. Placez les guerriers et les bâtiments restants et la carte Nomade <i>(face promue « Gardiens du Coffre » visible)</i> à côté du plateau.`,
