...
export default {
  ...
  faction: {
    alliance: {
      ...
      setup: `<ol><li>Piochez 3 cartes et placez-les face cachée dans votre pile de <b>partisans</b>.</li><li>Placez vos <b>bases</b> sur leurs emplacements réservés.</li><li>Remplissez votre piste de sympathie avec vos <b>jetons de Sympathie</b>.</li></ol>`,
    },
    corvid: {
      ...
      setup: `<ol><li>Choisissez une clairière en tant que territoire. Placez-y 1 <b>guerrier</b> et 1 <b>complot</b> de votre choix, face cachée.</li><li>Placez 1 <b>guerrier</b> dans une clairière de chaque couleur <i>(en comptant l’étape précédente, vous placerez donc 4 guerriers en tout)</i>.</li></ol>`,
    },
    cult: {
