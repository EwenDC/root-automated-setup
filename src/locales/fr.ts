...
export default {
  ...
  setupStep: {
    ...
    setUpMap: {
      body: "<li>Placez une ruine sur chaque emplacement du plateau marqué d’un « R » <i>(4 au total)</i>.</li><li>Placez ces objets sur leurs emplacements correspondants dans la réserve d’objets de la partie supérieure du plateau : 2 <Boot/>, 2 <Bag/>, 1 <Crossbow/>, 1 <Hammer/>, 2 <Sword/>, 2 <Tea/>, 2 <Coin/>.</li><li>Placez les deux dés à côté du plateau.</li>",
    },
    chooseDeck: {
