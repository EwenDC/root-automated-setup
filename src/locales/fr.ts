export default {
  ...
  faction: {
    ...
    warlord: {
      ...
      setup_vagabondSetUp: `<ol><li><b>Garnison.</b> Placez votre seigneur de guerre, 4 guerriers et 1 Bastion dans une clairière en coin qui n’est la clairière de départ en coin d’aucun autre joueur et, si possible, qui est diagonalement opposée à une clairière de départ en coin.</li><li><b>Devenir Tenace.</b> Placez la carte d’Humeur Tenace dans la case d’Humeur.</li></ol>`, // Loi de Root v2023.08.03@14.3
