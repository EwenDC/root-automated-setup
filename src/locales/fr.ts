...
export default {
  label: {
    ...
    placeMarkers: {
      priority:
        "<li>Prenez les 12 marqueurs de priorité, puis placez-en un dans chaque clairière, comme indiqué dans le schéma ci-dessous.</li>",
      ...
      suitPriority:
        "<li>Prenez les 12 marqueurs de couleur et les 12 marqueurs de priorité, puis placez-en un de chaque dans chaque clairière, comme indiqué dans le schéma ci-dessous.</li>",
    },
  ...
  setupStep: {
    ...
    placeScoreMarkers: {
      ...
      body_vagabondSetUp:
        "Chaque joueur place son marqueur de score sur la case « 0 » de la piste de score. Chaque joueur Vagabond prend les marqueurs de relation des factions en jeu (hors Vagabond) et les place sur la case Indifférent de son tableau de relations.",
    },
    chooseHand: {
  ...
  deck: {
    exiles: {
      ...
      setup_twoPlayer:
        "Prenez le paquet de cartes Exilés et Partisans dans la boîte de jeu et placez-le à côté du plateau. Retirez du paquet les quatre cartes Domination. Mélangez le paquet.",
    },
    standard: {
      name: "Base",
      ...
      /* Loi de Root v2@5.1.3 */
      setup_twoPlayer:
        "Prenez le paquet de cartes de base dans la boîte de jeu et placez-le à côté du plateau. Retirez du paquet les quatre cartes Domination. Mélangez le paquet.",
    },
  },
  expansion: {
    /* Loi de Root v2@B.5 */
  ...
  faction: {
    alliance: {
      ...
      setup:
        "<ol><li>Piochez 3 cartes et placez-les face cachée dans votre pile de <b>partisans</b>.</li><li>Placez vos <b>bases</b> sur leurs emplacements réservés.</li><li>Remplissez votre piste de sympathie avec vos <b>jetons de Sympathie</b>.</li></ol>",
    },
    corvid: {
      ...
      setup:
        "<ol><li>Choisissez une clairière en tant que territoire. Placez-y 1 <b>guerrier</b> et 1 <b>complot</b> de votre choix, face cachée.</li><li>Placez 1 <b>guerrier</b> dans une clairière de chaque couleur <i>(en comptant l’étape précédente, vous placerez donc 4 guerriers en tout)</i>.</li></ol>",
    },
    cult: {
  ...
  map: {
    autumn: {
      ...
      setup:
        "<li>Prenez le plateau Automne/Hiver dans la boîte de jeu et placez-le avec la face Automne visible.</li>",
    ...
    lake: {
      ...
      landmarkSetup:
        "<li>Placez le Radeau comme indiqué dans le schéma ci-dessous. Si vous avez la carte de lieu « Radeau », sortez-la de la boîte de jeu et placez-la à côté du plateau, face non-mise en place visible.</li>",
    },
    mountain: {
      name: "Montagne",
      ...
      landmarkSetup:
        "<li>Placez la Tour comme indiqué dans le schéma ci-dessous. Si vous avez la carte de lieu « Tour », sortez-la de la boîte de jeu et placez-la à côté du plateau, face non-mise en place visible.</li>",
    },
    winter: {
      name: "Hiver",
      setupTitle: "Mise en place du plateau Hiver",
      setup:
        "<li>Prenez le plateau Automne/Hiver dans la boîte de jeu et placez-le avec la face Hiver visible.</li>",
    },
  },
  vagabond: {
    /* Loi de Root v2@E.7 */
