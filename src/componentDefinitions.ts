    ...
    maps: {
      marsh: {
        ...
        clearings: [
          { x: 129.47, y: 152.05 },
          { x: 404.04, y: 147.32 },
          { x: 647.02, y: 170.17, floodGroup: 'circle', fallbackRuin: true },
          { x: 913.76, y: 222.14 },
          { x: 271.02, y: 352.69, floodGroup: 'square' },
          { x: 547.46, y: 374.69, ruin: true },
          { x: 809.37, y: 421.2, floodGroup: 'triangle', ruin: true },
          { x: 87.88, y: 548.68, floodGroup: 'square' },
          { x: 408.89, y: 539.66, ruin: true },
          { x: 650.83, y: 650.78, floodGroup: 'triangle', ruin: true },
          { x: 912.15, y: 632.68 },
          { x: 92.11, y: 831.66 },
          { x: 340.41, y: 756.54 },
          { x: 561.22, y: 847.17, floodGroup: 'circle', fallbackRuin: true },
          { x: 831.27, y: 852.68 },
        ],
        paths: [
          [0, 1],
